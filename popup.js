...
/**PCFRAME Stories - Sub-Tasks Created */
window.onload = () => {
  document.getElementById('storyPCFRAME').onclick = () => {
  ...
  /**PCFRAME Defects Button - Sub-Tasks Created */
  document.getElementById('defectPCFRAME').onclick = () => {
    var Sd = document.getElementById('SDs').value;
    var Ta = document.getElementById('TAs').value;
    var Se = document.getElementById('SEs').value;
    var Tl = document.getElementById('TLs').value;
